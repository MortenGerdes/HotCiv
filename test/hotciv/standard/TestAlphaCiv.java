...
public class TestAlphaCiv {
  ...
  @Before
  public void setUp() {
    game = new GameImpl(new AlphaCivAgeingStrategy(), new AlphaCivAttackingStrategy(), new GammaCivWorldAndBelowStrategy(), new AlphaCivWinnerStrategy(), new BetaCivAndBelowUnitActionStrategy());
  }
