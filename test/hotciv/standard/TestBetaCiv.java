...
public class TestBetaCiv {
    ...
    @Before
    public void setUp() {
        game = new GameImpl(new BetaCivAgeingStrategy(), new AlphaCivAttackingStrategy(), new GammaCivWorldAndBelowStrategy(), new BetaCivWinnerStrategy(), new BetaCivAndBelowUnitActionStrategy());
    }
